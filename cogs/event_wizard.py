...
class EventCreateModal(discord.ui.Modal, title="Create Event"):
    def __init__(self, tag_type: str):
        ...
        self.add_item(self.title_in); self.add_item(self.date_in)
        self.add_item(self.time_in);  self.add_item(self.loc_in); self.add_item(self.desc_in)
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await view.wait()
        # Persist view.selected as needed
